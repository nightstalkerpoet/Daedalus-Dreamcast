...
BEGIN_PATCH_XREFS(osContInit)
  ...
  PATCH_XREF_FUNCTION(23, __ll_mul)
  ...
  PATCH_XREF_FUNCTION(52, __ll_mul)
...
//               __osSpRawReadIo
////////////////////////////////////////////////////////////
BEGIN_PATCH_XREFS(__osSpRawReadIo_Mario)
  PATCH_XREF_FUNCTION(3, __osSiDeviceBusy)
END_PATCH_XREFS()
BEGIN_PATCH_XREFS(__osSpRawReadIo_Zelda)
  PATCH_XREF_FUNCTION(3, __osSiDeviceBusy)
END_PATCH_XREFS()
BEGIN_PATCH_SIGNATURE_LIST(__osSpRawReadIo)
   PATCH_SIGNATURE_LIST_ENTRY(__osSpRawReadIo_Mario, 20, 9, 0x2af9bd43, 0x2b3aaa41)
   PATCH_SIGNATURE_LIST_ENTRY(__osSpRawReadIo_Zelda, 19, 9, 0x2af9bd43, 0x2e01f600)
END_PATCH_SIGNATURE_LIST()

PATCH_SYMBOL_FUNCTION(__osSpRawReadIo)


////////////////////////////////////////////////////////////
//              __osSpRawWriteIo
////////////////////////////////////////////////////////////
BEGIN_PATCH_XREFS(__osSpRawWriteIo_Mario)
  PATCH_XREF_FUNCTION(3, __osSiDeviceBusy)
END_PATCH_XREFS()
BEGIN_PATCH_XREFS(__osSpRawWriteIo_Zelda)
  PATCH_XREF_FUNCTION(3, __osSiDeviceBusy)
END_PATCH_XREFS()
BEGIN_PATCH_SIGNATURE_LIST(__osSpRawWriteIo)
   PATCH_SIGNATURE_LIST_ENTRY(__osSpRawWriteIo_Mario, 19, 9, 0x2af9bd43, 0x68833de2)
   PATCH_SIGNATURE_LIST_ENTRY(__osSpRawWriteIo_Zelda, 18, 9, 0x2af9bd43, 0x75bb0823)
END_PATCH_SIGNATURE_LIST()

PATCH_SYMBOL_FUNCTION(__osSpRawWriteIo)
...
//                    A__ull_rem
////////////////////////////////////////////////////////////
BEGIN_PATCH_XREFS(A__ull_rem)
END_PATCH_XREFS()
BEGIN_PATCH_SIGNATURE_LIST(A__ull_rem)
   PATCH_SIGNATURE_LIST_ENTRY(A__ull_rem, 15, 43, 0xfb20959a, 0xd50a95ae)
END_PATCH_SIGNATURE_LIST()

PATCH_SYMBOL_FUNCTION(A__ull_rem)
...
//                      __ll_mul
////////////////////////////////////////////////////////////
BEGIN_PATCH_XREFS(__ll_mul)
END_PATCH_XREFS()
BEGIN_PATCH_SIGNATURE_LIST(__ll_mul)
   PATCH_SIGNATURE_LIST_ENTRY(__ll_mul, 12, 43, 0xfb20959a, 0x2e2b7b73)
END_PATCH_SIGNATURE_LIST()

PATCH_SYMBOL_FUNCTION(__ll_mul)
...
BEGIN_PATCH_XREFS(__lldiv)
  ...
  PATCH_XREF_FUNCTION(15, __ll_mul)
END_PATCH_XREFS()
...
PATCH_FUNCTION_ENTRY(__osSpRawReadIo)
PATCH_FUNCTION_ENTRY(__osSpRawWriteIo)
...
PATCH_FUNCTION_ENTRY(A__ull_rem)
